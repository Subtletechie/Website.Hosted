...
export const courses = [
  ...
  },
  {
    ...
    description:
      "A comprehensive 12-week program covering the full spectrum of AI security engineering — from securing ML pipelines and LLM applications to building AI governance frameworks used in enterprise environments.",
    outcomes: [
      "AI/ML threat modeling & attack surface analysis",
      "Securing LLM applications against prompt injection & data leakage",
      "ML pipeline security: data, training, deployment & monitoring",
      "AI governance frameworks & risk management",
      "Hands-on labs with real AI security tooling",
      "1-on-1 resume review for AI security roles",
      "Interview prep with mock Q&A & expert feedback",
      "Exclusive course resources & study materials",
    ],
    featured: true,
    featuredLabel: "🔥 New Course",
    commitment: "",
    cta: "Enroll Now",
  },
  {
